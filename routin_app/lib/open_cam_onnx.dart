...
class OpenCamState extends State<OpenCam> {
  ...
  Future<void> runModelOnStreamFrame() async {
    ...
    try {
      // YUV420 veya BGRA8888 -> RGB dönüşümü
      img.Image? image = convertYUV420ToImage(imgCamera!);

      if (image == null) {
        print("Görüntü dönüştürme başarısız");
        isWorking = false;
        return;
      }

      print("Görüntü boyutu: ${image.width}x${image.height}");

      // 640x640'a resize et - MODEL BU BOYUTU BEKLİYOR
